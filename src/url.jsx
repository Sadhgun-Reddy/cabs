...
export const URLS = {
    ...
    UpdateServiceCategoryStatus: base_url + "v1/gkcabs/admin/servicetype/updateservicestatus",
    ...
    UpdateFarePlanStatus: base_url + "v1/gkcabs/admin/fairplan/updatestatus",
}
