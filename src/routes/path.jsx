...
import UnverifiedDriver from "../feature-module/Driver/unverifiedDriver";
import DriverRules from "../feature-module/Driver/driverRules";
import Driverwallet from "../feature-module/Driver/driverWallet";
import Driverdocument from "../feature-module/Driver/driverDocument";
import Commissionhostories from "../feature-module/Driver/commissionHistories";
import WithdrawRequest from "../feature-module/Driver/withdrawRequest";
import DriverMap from "../feature-module/Driver/driverLocation";
...
import Editdriverdocument from "../feature-module/Driver/editdriverDocument";
import EditAirportZones from "../feature-module/Airportzones/editairportZones";
import EditZones from "../feature-module/Zones/editZones";
...
import AccpetedRides from "../feature-module/Rides/accpetedRides";
import StartedRides from "../feature-module/Rides/startedRides";
import ArrivedRides from "../feature-module/Rides/arrivedRides";
import CancelledRides from "../feature-module/Rides/cancelledRides";
...
export const authRoutes = [
  ...
  {
    id: 1,
    path: routes.cancelledrides,
    name: "Ride",
    element: <CancelledRides />,
    route: Route,
  },
  {
    id: 1,
    path: routes.startedrides,
    name: "Ride",
    element: <StartedRides />,
    route: Route,
  },
  {
    id: 1,
    path: routes.arrivedrides,
    name: "Ride",
    element: <ArrivedRides />,
    route: Route,
  },
  {
    id: 1,
    path: routes.accpetedrides,
    name: "Ride",
    element: <AccpetedRides />,
    route: Route,
  },
  {
    id: 1,
    path: routes.scheduledrides,
    name: "Ride",
  ...
  {
    id: 1,
    path: routes.addvehiclegroup,
    name: "Vehicle Manage",
    element: <AddVehicleGroup />,
    route: Route,
  },
  {
    id: 1,
  ...
  {
    id: 1,
    path: routes.walletcomments,
    name: "Wallet Comments",
    element: <WalletComments />,
    route: Route,
  },
  {
    id: 1,
  ...
  {
    id: 1,
    path: routes.sendpushnotification,
  ...
  {
    id: 1,
    path: routes.addincentive,
    name: "Service",
    element: <AddIncentivesModal />,
    route: Route,
  },
  {
    id: 1,
    path: routes.setworldprice,
    name: "Service",
    element: <SetWorldPrice />,
    route: Route,
  },
  {
    id: 1,
    path: routes.vehicletypezone,
    name: "Service",
    element: <VehicleZone />,
    route: Route,
  },
  ...
  {
    id: 1,
    path: routes.serviceCategorie,
    name: "Service",
    element: <SerivceCategorie />,
    route: Route,
  },
  {
    id: 1,
    path: routes.editdriverdocument,
    name: "Driver",
  ...
  },
  {
    ...
    name: "Driver",
    element: <Adddriverdocument />,
    route: Route,
  },
  {
    id: 1,
    path: routes.driverlocation,
    name: "Driver",
    element: <DriverMap />,
    route: Route,
  },
  ...
  {
    id: 1,
    path: routes.Commissionhostories,
    name: "Driver",
    element: <Commissionhostories />,
    route: Route,
  },
  {
    id: 1,
    path: routes.driverDocument,
    name: "Driver",
  ...
  {
    id: 1,
    path: routes.UnverifiedDriver,
    name: "Driver",
    element: <UnverifiedDriver />,
    route: Route,
  },
  {
    id: 1,
    path: routes.Verifieddriver,
    name: "Driver",
    element: <Verifieddriver />,
    route: Route,
  },
  {
    id: 1,
    path: routes.riderwallet,
    name: "Rider",
    element: <Riderwallet />,
    route: Route,
  },
  ...
  {
    id: 1,
    path: routes.editairportzones,
    name: "Airportzones",
    element: <EditAirportZones />,
    route: Route,
  },
  {
    id: 1,
    path: routes.Addairportzones,
    name: "Airportzones",
    element: <Addairportzones />,
    route: Route,
  },
  {
    id: 1,
    path: routes.Airportzones,
    name: "airportzones",
    element: <AirportZones />,
    route: Route,
  },
  {
    id: 1,
    path: routes.editzones,
    name: "Zones",
    element: <EditZones />,
    route: Route,
  },
