...
export const SidebarData = [
  {
    ...
    submenuItems: [
      ...
      },
      {
        ...
        submenuItems: [
          { label: "All Zones", link: "/zones" },
          { label: "Add Zones", link: "/addzones" },
      ...
      },
      {
        ...
        showSubRoute: false,
        submenuItems: [
          { label: "Ride Requests", link: "/rideRequest"},
          { label: "All Rides", link: "/allRides"},
          { label: "Scheduled Rides", link: "/scheduledRides"},
          { label: "Accepted Rides", link: "/accpetedRides"},
          { label: "Arrived Rides", link: "/arrivedRides"},
          { label: "Started Rides", link: "/startedRides"},
          { label: "Cancelled Rides", link: "/cancelledRides"},
          { label: "Completed Rides", link: "/completedRides"},
        ]
      },
      {
        label: "Service Type",
  ...
  //         { label: "POS 6", link: "https://Gk Cabs.dreamstechnologies.com/laundry-pos/reactjs/template/login", showSubRoute: false,external: true  },
  //       ],
  //     },
  //   ],
  // },
    ...
    submenuItems: [
      ...
      // },
      {
        ...
        submenuItems: [
          ...
          { label: "Commission", link: "/commission", showSubRoute: false },
          { label: "Ride Settings", link: "/ridesettings", showSubRoute: false },
          {
            label: "Wallet Settings",
            link: "/walletsettings",
            showSubRoute: false,
          },
          { label: "Refferal Settings", link: "/ridesettings", showSubRoute: false },
  ...
  //     {
  //       label: "Documentation",
  //       link: "https://Gk Cabs.dreamstechnologies.com/documentation/react.html",
  //       icon: "file-text",
  //       showSubRoute: false,
  //     },
  //     {
  //       label: "Changelog v2.2.2",
  //       link: "https://Gk Cabs.dreamstechnologies.com/documentation/changelog.html",
  //       icon: "exchange",
  //       showSubRoute: false,
  //     },
  //   ],
